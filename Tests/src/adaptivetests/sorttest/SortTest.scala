...
import scalaadaptive.core.configuration.blocks.WindowBoundRegressionPredictiveStrategy
...
object SortTest {
  ...
  def main(args: Array[String]): Unit = {
    Adaptive.initialize(new FullHistoryTTestConfiguration with WindowBoundRegressionPredictiveStrategy)
