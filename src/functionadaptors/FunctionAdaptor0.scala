...
class FunctionAdaptor0[R](private val options: List[RunOption[() => R]],
  ...
  def or(fun: Function0[R]): Function0[R] = orAdaptor(Implicits.toAdaptor0(fun))
  private def orAdaptor(fun: FunctionAdaptor0[R]): Function0[R] = new FunctionAdaptor0[R](this.options ++ fun.options)
