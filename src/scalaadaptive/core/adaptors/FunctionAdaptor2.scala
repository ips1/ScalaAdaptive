...
class FunctionAdaptor2[I1, I2, R](private val options: List[RunOption[(I1, I2) => R]],
                                  private val selector: (I1, I2) => Int = null,
  ...
  override def by(newSelector: (I1, I2) => Int): (I1, I2) => R =
    new FunctionAdaptor2[I1, I2, R](options, newSelector, storage)
  ...
  private def createInputDescriptor(v1: I1, v2: I2) = if (selector != null) selector(v1, v2) else 0
}